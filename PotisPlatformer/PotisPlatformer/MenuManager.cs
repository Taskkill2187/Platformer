...
namespace Platformer
{
    public static class MenuManager
    {
        ...
        public static void BuildMenus()
        {
            ...
            ((Button)MainMenu.ControlElementList[1]).OnClick += (object sender, EventArgs e) => { GS = GameState.LevelCreator; if (LevelCreator.Testing) { MediaPlayer.Play(Assets.InGameTheme); } };
            ...
            Options.ControlElementList.Add(new Button("???", new Vector2(), Color.White, Assets.BigFont));
