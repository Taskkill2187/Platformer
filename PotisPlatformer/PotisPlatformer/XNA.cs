    ...
    public class XNA : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            switch (MenuManager.GS)
            {
                case GameState.MainMenu:
                    ...
                    if (Controls.CurKS.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Escape) && Controls.LastKS.IsKeyUp(Microsoft.Xna.Framework.Input.Keys.Escape) || MenuManager.Exiting)
                        Exit();
                    break;

                case GameState.Options:
                    MenuManager.Options.Update();
                    if (Controls.CurKS.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.Escape))
                        MenuManager.GS = GameState.MainMenu;
                    break;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (MenuManager.GS == GameState.InGame || MenuManager.GS == GameState.LevelCreator)
            {
                ...
                {
                    int x = (int)(-LevelManager.CurrentLevel.Camera.X / 20 % LevelManager.CurrentLevel.Background.Width);
                ...
                else
                {
                    ...
                    int x = (int)(-LevelManager.CurrentLevel.Camera.X / 20 % DefaultBackground.Width);
